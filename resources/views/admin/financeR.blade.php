...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">Gestion Finance Récolte</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">Dashboard</a></li>
                <li class="breadcrumb-item active">Gestion Finance Récolte</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('index10.finance_recolte') }}" method="get">
                    @csrf
                    @method('get')
                ...
                <a href="{{ route('pdf8') }}">  <button type="submit" class="he he2"><i class="fa-solid fa-download"></i>Exporter</button></a>
                <br><br>
                <?php $i = 0; ?>
